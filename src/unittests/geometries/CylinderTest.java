...
class CylinderTest {
    ...
    void testFindIntersections() {
        ...
        // TC06: Ray at angle, intersects one side and one cap (2 points)
        ray = new Ray(new Vector(0.5, 0, 1), new Point(-1, 0, -1));
        result = cylinder.findIntersections(ray);
        assertNotNull(result, "TC06: Ray through side and cap should intersect");
        ...
        ray = new Ray(new Vector(1, 0, 0.1).normalize(), new Point(0, 0, -0.1));
        assertNull(cylinder.findIntersections(ray),
        ...
        ray = new Ray(new Vector(1, 1, 1).normalize(), new Point(0, 0, 0));
        result = cylinder.findIntersections(ray);
