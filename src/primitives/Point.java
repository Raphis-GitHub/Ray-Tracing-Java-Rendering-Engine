...
public class Point {
    ...
    public double distanceSquared(Point otherPoint) {
        return ((otherPoint.xyz.d1 - this.xyz.d1) * (otherPoint.xyz.d1 - this.xyz.d1) + (otherPoint.xyz.d2 - this.xyz.d2) * (otherPoint.xyz.d2 - this.xyz.d2) + (otherPoint.xyz.d3 - this.xyz.d3) * (otherPoint.xyz.d3 - this.xyz.d3));
    }
